...
const defaultDb = {
  ...
  lore: [
    ...
    {
      id: "lore-other",
      category: "Великие личности",
      tone: "lore-tone--violet",
      items: [
        "Имя: Арвел Седой Клятвы. Титул: Домоправитель Серебряного Дома. Роль: Хранитель северных дорог и сборщик клятв. Описание: Держит под своей властью трактовые заставы, умеет покупать верность не золотом, а обязательствами, и считает порядок важнее милосердия. Изображение: ",
        "Имя: Леди Мирель из Башен. Титул: Голос Совета Магистров. Роль: Посредница между князем-наместником и башенными орденами. Описание: Известна ледяной вежливостью, идеальной памятью и умением склонять спорящих магов к одному решению, не повышая голоса. Изображение: "
      ]
    }
  ],
  characterRequests: [],
